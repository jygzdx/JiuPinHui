...
import com.jiupin.jiupinhui.presenter.impl.BeforeChatActivityPresenterImpl;
...
/**
 * 售前聊天界面
 * 后台售后，售前使用的接口不一样，直接分成两个界面来写
 */
public class BeforeChatActivity extends BaseActivity implements IBeforeChatActivityView{
    ...
    private IBeforeChatActivityPresenter presenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        presenter = new BeforeChatActivityPresenterImpl(this);
    ...
    private void initData() {
        presenter.getChatInfo(token, consultId);
    }
                ...
                if (isFirst) {
                    ...
                    if (height < firstHeight) {//键盘打开
                        if(llInputText.getVisibility()==View.GONE){
                            ...
                            //屏幕的高度
                            int windowHeight = WindowUtils.getWindowHeight(BeforeChatActivity.this);
                            //输入框的高度--写死的
