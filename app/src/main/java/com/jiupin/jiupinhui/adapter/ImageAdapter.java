...
public class ImageAdapter extends RecyclerView.Adapter {
    ...
    public ImageAdapter(Context mContext, String[] imgUrls) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if(getItemCount()<=2){//图片的数量小于等于2
            LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(DensityUtils.dp2px(mContext,140),DensityUtils.dp2px(mContext,140));
        ...
        holder.ivImg.setScaleType(ImageView.ScaleType.CENTER_CROP);
        return holder;
    }
