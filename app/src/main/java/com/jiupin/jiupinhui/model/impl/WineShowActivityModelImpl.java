...
public class WineShowActivityModelImpl implements IWineShowActivityModel {

    @Override
    public void getGoodsInfo(String goodsId, final IModel.CallBack callBack) {
        OkHttpUtils
                .post()
                .url(Constant.GET_WINE_DETAIL_BY_CID)
