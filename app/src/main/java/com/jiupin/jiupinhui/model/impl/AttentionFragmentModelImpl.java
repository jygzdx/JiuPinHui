...
public class AttentionFragmentModelImpl implements IAttentionFragmentModel {

    @Override
    public void getAttentionList(String token, String page, String rows, final IModel.CallBack callBack) {
        OkHttpUtils
                .post()
                .url(Constant.ATTENTION_CONDITION)
